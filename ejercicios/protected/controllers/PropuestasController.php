...
class PropuestasController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Propuestas'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Propuestas');
	...
	{
		$model=Propuestas::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Propuestas $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='propuestas-form')
		{
